/*
  EXAMPLE TASK:
    ...
    - All airplanes built with Airplane should initialize with an `isFlying` property 
    of false.
...
/*
  TASK 2
    ...
    - Give cars the ability to get fueled with a `.fill(gallons)` method. Add the 
    gallons to `tank`.
...
drive(distance){
  ...
  this.tank = this.tank - (distance/this.milesPerGallon);
      ...
      if (this.tank <= 0){
    this.tank = 0;
    return `I ran out of fuel at ${this.odometer} miles!` && this.tank;
  }
...
/*
  TASK 4
    ...
    - Instructor instances have the following methods:
        + `demo` receives a `subject` string as an argument and returns the
         phrase 'Today we are learning about {subject}' where subject is the 
         param passed in.
...
class Student extends Lambdasian {
  ...
  //     + This method, when called, will check the grade of the student and see if 
  //     they're ready to graduate from Lambda School
  //     + If the student's grade is above a 70% let them graduate! Otherwise go back 
  //     to grading their assignments to increase their score.
constructor(obj){
super(obj);
